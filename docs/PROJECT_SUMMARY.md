# Linkmap 프로젝트 구현 요약 문서

## 1. 프로젝트 개요

### 1.1 프로젝트명
**Linkmap** - 서비스 연결을 한눈에, 안전하게 관리하는 플랫폼
...
- CLI 도구 (`linkmap pull`, `linkmap check`)
