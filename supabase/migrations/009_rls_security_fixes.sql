...
--
-- 주의: 이 마이그레이션은 002~008 마이그레이션이 모두 적용된 후 실행해야 합니다.
-- 현재 적용된 마이그레이션: 001만 적용됨 (2026-02-10 기준)
-- 실행 순서: 001 → 002 → 003 → 004 → 005 → 006 → 007 → 008 → 009
-- ============================================

-- ============================================
-- 즉시 적용 가능 (001 테이블 대상)
-- user_checklist_progress DELETE 정책 누락 수정
-- ============================================
