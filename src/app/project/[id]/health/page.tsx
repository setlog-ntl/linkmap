...
export default function ProjectHealthPage() {
  ...
  // Latest health check per service, initialized from server then updated by mutations
  ...
  // Selected service health checks for timeline
  const { data: selectedChecks = [] } = useHealthChecks(selectedPsId || '');

  // Compute sparkline data from selected checks
