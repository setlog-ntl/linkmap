import type { BlogTopicTag } from './blog-tags';
...
export const BLOG_POSTS_META: BlogPostMeta[] = [
  ...
  // ======================================================================
  {
    ...
    description: '책은 많이 읽었지만 기록은 늘 흩어졌다. 노션, Firebase, 수많은 실패를 거쳐 AI와 함께 내가 쓸 독서 기록 앱을 만들기까지 — 읽는 사람이 만드는 사람이 된 이야기.',
    topicTags: ['vibe-coding'],
    tags: ['바이브 코딩', '사용자에서 창작자로', '시대 전환', '바이브코딩 입문', 'AI 코딩', '독서 기록'],
    publishedAt: '2026-04-03',
    readingTime: '10분',
