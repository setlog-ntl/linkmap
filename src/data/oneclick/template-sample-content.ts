...
export const smallBizSample: { ko: SmallBizContent; en: SmallBizContent } = {
  ko: {
    nameKo: '연남 사케하우스 夜宴',
    nameEn: 'Yeonnam Sake House',
    descriptionKo: '프리미엄 사시미와 사케를 즐기는 모던 요리주점',
    descriptionEn: 'Modern Japanese dining with premium sashimi and sake',
    phone: '02-335-7890',
    address: '서울 마포구 연남로 23길 12, 1층',
    addressEn: '1F, 12, Yeonnam-ro 23-gil, Mapo-gu, Seoul',
    kakaoMapId: '',
    menuItems: [
      {
        nameKo: '모둠사시미',
        nameEn: 'Assorted Sashimi',
        descKo: '오늘의 신선한 생선 5종, 셰프가 직접 선별',
      ...
      {
        nameKo: '닷사이 23 준마이다이긴조',
        nameEn: 'Dassai 23 Junmai Daiginjo',
        descKo: '야마구치현, 정미율 23%. 맑고 과일 향이 풍부',
      ...
      },
      {
        nameKo: '와규 타타키',
        nameEn: 'Wagyu Tataki',
        descKo: 'A5 와규를 살짝 구워 폰즈 소스에 곁들임',
    ...
    hours: [
      { dayKo: '월요일', dayEn: 'Monday', hoursKo: '정기휴무', hoursEn: 'Closed', isHoliday: true },
      { dayKo: '화요일', dayEn: 'Tuesday', hoursKo: '17:00 - 24:00', hoursEn: '17:00 - 24:00' },
      { dayKo: '수요일', dayEn: 'Wednesday', hoursKo: '17:00 - 24:00', hoursEn: '17:00 - 24:00' },
      { dayKo: '목요일', dayEn: 'Thursday', hoursKo: '17:00 - 24:00', hoursEn: '17:00 - 24:00' },
      { dayKo: '금요일', dayEn: 'Friday', hoursKo: '17:00 - 01:00', hoursEn: '17:00 - 01:00' },
      { dayKo: '토요일', dayEn: 'Saturday', hoursKo: '17:00 - 01:00', hoursEn: '17:00 - 01:00' },
      { dayKo: '일요일', dayEn: 'Sunday', hoursKo: '17:00 - 23:00', hoursEn: '17:00 - 23:00' },
    ],
...
export const smallBizCafeSample: { ko: SmallBizContent; en: SmallBizContent } = {
  ko: {
    nameKo: '카페 라이츠',
    nameEn: 'Kafe Wrights',
    descriptionKo: '모던한 인테리어와 어우러진 감성 카페',
    ...
    menuItems: [
      {
        ...
        descKo: '진한 에스프레소에 사과크림과 시나몬',
        descEn: 'Espresso with apple cream and cinnamon',
        price: '₩7,800',
        category: '시그니처',
        emoji: '☕',
      },
      {
        nameKo: '크랑떼',
        nameEn: 'Crangtte',
        descKo: '크루아상 결의 바삭한 페이스트리',
        descEn: 'Crispy croissant-layered pastry',
        price: '₩4,800',
        category: '시그니처',
        emoji: '🥐',
      },
      {
        nameKo: 'MONTHLY PAIRING',
        nameEn: 'Monthly Pairing',
        descKo: '매달 새로운 샌드위치+에이드 페어링',
        descEn: 'A new pairing every month',
        price: '변동',
        category: '시그니처',
        emoji: '🥪',
      },
      {
        nameKo: '플랫화이트',
        nameEn: 'Flat White',
        descKo: '크리미한 우유와 진한 에스프레소',
        descEn: 'Creamy milk with a bold espresso',
        price: '₩6,300',
        category: '커피',
        emoji: '☕',
      },
      {
        ...
        descKo: '보성 말차의 깊은 풍미',
        descEn: 'Deep flavor of Boseong matcha',
        price: '₩8,000',
        category: '티·라떼',
        emoji: '🍵',
      },
      {
        ...
        nameEn: 'Lemon Ade',
        descKo: '청량한 레몬 스파클링',
        descEn: 'Refreshing lemon sparkling ade',
        price: '₩7,000',
        category: '에이드',
        emoji: '🍋',
      },
    ...
    hours: [
      { dayKo: '월요일', dayEn: 'Monday', hoursKo: '08:00 - 22:30', hoursEn: '08:00 - 22:30' },
      { dayKo: '화요일', dayEn: 'Tuesday', hoursKo: '08:00 - 22:30', hoursEn: '08:00 - 22:30' },
      { dayKo: '수요일', dayEn: 'Wednesday', hoursKo: '08:00 - 22:30', hoursEn: '08:00 - 22:30' },
      { dayKo: '목요일', dayEn: 'Thursday', hoursKo: '08:00 - 22:30', hoursEn: '08:00 - 22:30' },
      { dayKo: '금요일', dayEn: 'Friday', hoursKo: '08:00 - 22:30', hoursEn: '08:00 - 22:30' },
      { dayKo: '토요일', dayEn: 'Saturday', hoursKo: '08:00 - 22:30', hoursEn: '08:00 - 22:30' },
  ...
  en: {
    nameKo: '블룸 커피',
    nameEn: 'Bloom Coffee',
    descriptionKo: '전문 바리스타가 내리는 스페셜티 커피',
    descriptionEn: 'Specialty coffee crafted by expert baristas',
    phone: '+1 (323) 555-0187',
    address: '456 Silver Lake Blvd, Los Angeles, CA 90026',
    addressEn: '456 Silver Lake Blvd, Los Angeles, CA 90026',
    kakaoMapId: '',
    menuItems: [
      {
        nameKo: '아메리카노',
      ...
      },
      {
        ...
        descKo: '오트밀크 라떼',
        descEn: 'Espresso with creamy oat milk',
        price: '$6.50',
        category: 'Coffee',
        emoji: '☕',
      },
      {
        ...
        nameEn: 'Cold Brew',
        descKo: '24시간 저온 추출',
        descEn: '24-hour cold extraction',
        price: '$6',
        category: 'Coffee',
        emoji: '🧊',
      },
      {
        nameKo: '바나나 브레드',
        nameEn: 'Banana Bread',
        descKo: '집에서 구운 바나나 브레드',
        descEn: 'Homemade banana bread',
        price: '$5',
        category: 'Pastry',
        emoji: '🍌',
      },
    ...
    hours: [
      { dayKo: '월요일', dayEn: 'Monday', hoursKo: '07:00 - 18:00', hoursEn: '07:00 AM - 06:00 PM' },
      { dayKo: '화요일', dayEn: 'Tuesday', hoursKo: '07:00 - 18:00', hoursEn: '07:00 AM - 06:00 PM' },
      { dayKo: '수요일', dayEn: 'Wednesday', hoursKo: '07:00 - 18:00', hoursEn: '07:00 AM - 06:00 PM' },
      { dayKo: '목요일', dayEn: 'Thursday', hoursKo: '07:00 - 18:00', hoursEn: '07:00 AM - 06:00 PM' },
      { dayKo: '금요일', dayEn: 'Friday', hoursKo: '07:00 - 19:00', hoursEn: '07:00 AM - 07:00 PM' },
      { dayKo: '토요일', dayEn: 'Saturday', hoursKo: '08:00 - 19:00', hoursEn: '08:00 AM - 07:00 PM' },
      { dayKo: '일요일', dayEn: 'Sunday', hoursKo: '08:00 - 17:00', hoursEn: '08:00 AM - 05:00 PM' },
    ],
...
export const invitationSample: { ko: InvitationContent; en: InvitationContent } = {
  ko: {
    ...
    subtitle: '여섯 번의 계절을 함께 걸어온 두 사람이 이제 같은 이름의 겨울을 맞이합니다',
    ...
    hosts: [
      { name: '김민준', nameEn: 'Minjun Kim', role: '신랑 · 김영호·박정숙의 장남', roleEn: 'Groom · Son of Youngho Kim & Jeongsuk Park', phone: '010-2345-6789' },
      { name: '이서연', nameEn: 'Seoyeon Lee', role: '신부 · 이재현·최은주의 차녀', roleEn: 'Bride · Second Daughter of Jaehyun Lee & Eunju Choi', phone: '010-9876-5432' },
    ],
  ...
  en: {
    ...
    titleEn: "We're Getting Married",
    subtitle: 'Two people who have walked through six seasons together now welcome a winter under one shared name.',
    subtitleEn: 'Two people who have walked through six seasons together now welcome a winter under one shared name.',
    eventType: 'wedding',
    eventDate: '2026-12-19',
    eventTime: '14:00',
    eventDateLabel: 'Saturday, December 19, 2026 at 2:00 PM',
    eventDateLabelEn: 'Saturday, December 19, 2026 at 2:00 PM',
    hostsTitle: 'Hosted by',
    hostsTitleEn: 'Hosted by',
    hosts: [
      { name: 'Minjun Kim', nameEn: 'Minjun Kim', role: 'Groom · Son of Youngho Kim & Jeongsuk Park', roleEn: 'Groom · Son of Youngho Kim & Jeongsuk Park', phone: '010-2345-6789' },
      { name: 'Seoyeon Lee', nameEn: 'Seoyeon Lee', role: 'Bride · Second Daughter of Jaehyun Lee & Eunju Choi', roleEn: 'Bride · Second Daughter of Jaehyun Lee & Eunju Choi', phone: '010-9876-5432' },
    ],
    venueName: 'Raonjena Hall, 3F Grand Ballroom',
    venueNameEn: 'Raonjena Hall, 3F Grand Ballroom',
    venueAddress: '129 Teheran-ro, Gangnam-gu, Seoul',
    venueAddressEn: '129 Teheran-ro, Gangnam-gu, Seoul',
    accountTitle: 'Send Your Wishes',
    accountTitleEn: 'Send Your Wishes',
    accounts: [
      { label: "Groom's Side", bankName: 'Kookmin Bank', accountNumber: '123456-04-789012', holder: 'Minjun Kim' },
      { label: "Bride's Side", bankName: 'Shinhan Bank', accountNumber: '110-234-567890', holder: 'Seoyeon Lee' },
    ],
    contacts: [
      { name: 'Minjun Kim', phone: '010-2345-6789', role: 'Groom' },
      { name: 'Seoyeon Lee', phone: '010-9876-5432', role: 'Bride' },
    ],
  },
};
