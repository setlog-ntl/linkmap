...
export const smallBizCafeSample: { ko: SmallBizContent; en: SmallBizContent } = {
  ko: {
    ...
    descriptionKo: '매일 아침, 직접 로스팅한 한 잔의 커피',
    ...
    menuItems: [
      {
        nameKo: '아메리카노',
        nameEn: 'Americano',
        descKo: '매일 로스팅한 싱글 오리진 원두',
        descEn: 'Daily roasted single-origin beans',
        price: '₩5,000',
        category: '커피',
        emoji: '☕',
      },
      {
        nameKo: '카페라떼',
        nameEn: 'Cafe Latte',
        descKo: '고소한 우유와 에스프레소의 조화',
        descEn: 'Perfect harmony of milk and espresso',
        price: '₩5,500',
        category: '커피',
        emoji: '☕',
      },
      {
        nameKo: '콜드브루',
        nameEn: 'Cold Brew',
        descKo: '18시간 저온 추출 콜드브루',
        descEn: '18-hour cold extraction',
        price: '₩5,500',
        category: '커피',
        emoji: '🧊',
      },
      ...
      },
      {
        nameKo: '당근케이크',
        nameEn: 'Carrot Cake',
        descKo: '크림치즈 프로스팅의 당근케이크',
        descEn: 'Carrot cake with cream cheese frosting',
        price: '₩7,000',
        category: '디저트',
        emoji: '🥕',
      },
      {
        nameKo: '크루아상',
        nameEn: 'Croissant',
        descKo: '프랑스산 버터 48겹 수제',
        descEn: '48-layer handmade with French butter',
        price: '₩4,500',
        category: '디저트',
        emoji: '🥐',
      },
    ...
    hours: [
      { dayKo: '월요일', dayEn: 'Monday', hoursKo: '정기휴무', hoursEn: 'Closed', isHoliday: true },
      { dayKo: '화요일', dayEn: 'Tuesday', hoursKo: '09:00 - 22:00', hoursEn: '09:00 - 22:00' },
      { dayKo: '수요일', dayEn: 'Wednesday', hoursKo: '09:00 - 22:00', hoursEn: '09:00 - 22:00' },
      { dayKo: '목요일', dayEn: 'Thursday', hoursKo: '09:00 - 22:00', hoursEn: '09:00 - 22:00' },
      { dayKo: '금요일', dayEn: 'Friday', hoursKo: '09:00 - 22:00', hoursEn: '09:00 - 22:00' },
      { dayKo: '토요일', dayEn: 'Saturday', hoursKo: '09:00 - 22:00', hoursEn: '09:00 - 22:00' },
      { dayKo: '일요일', dayEn: 'Sunday', hoursKo: '09:00 - 22:00', hoursEn: '09:00 - 22:00' },
    ],
    instagramUrl: 'https://instagram.com/ongi_roastery',
    naverBlogUrl: '',
    kakaoChannelUrl: '',
  },
  en: {
