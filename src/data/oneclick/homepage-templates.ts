...
export const homepageTemplateSeedData: HomepageTemplateSeed[] = [
  ...
  // ──────────────────────────────────────────────
  {
    ...
    name_ko: '요리주점/레스토랑',
    description:
      'Mobile-optimized restaurant & bar page with menu, hours, Kakao Map, gallery, and one-tap call. Perfect for izakayas, restaurants, and bars.',
    description_ko:
      '요리주점, 레스토랑, 바를 위한 모바일 최적화 홍보 페이지. 메뉴판, 영업시간, 카카오맵, 갤러리, 전화 연결.',
    preview_image_url: null,
    github_owner: 'linkmap-templates',
    ...
    required_env_vars: [
      ...
      { key: 'NEXT_PUBLIC_YOUTUBE_URL', description: '유튜브 채널 URL', required: false },
  ...
  },
  {
    ...
    name_ko: '카페/음료 전문점',
    description:
      'Mobile-optimized cafe & coffee shop page with menu, hours, Kakao Map, gallery, and one-tap call. Perfect for cafes, bakeries, and dessert shops.',
    description_ko:
      '카페, 베이커리, 디저트 전문점을 위한 모바일 최적화 홍보 페이지. 메뉴판, 영업시간, 카카오맵, 갤러리, 전화 연결.',
    preview_image_url: null,
    github_owner: 'linkmap-templates',
    github_repo: 'small-biz-cafe',
    default_branch: 'main',
    framework: 'nextjs',
    required_env_vars: [
      { key: 'NEXT_PUBLIC_SITE_NAME', description: '가게 이름', required: true },
