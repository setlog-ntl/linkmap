...
export const siteConfig = {
  ...
  hosts: [
    { name: '김민준', nameEn: 'Minjun Kim', role: '신랑 · 김영호·박정숙의 장남', roleEn: 'Groom · Son of Youngho Kim & Jeongsuk Park', phone: '010-2345-6789', avatarUrl: '' },
    { name: '이서연', nameEn: 'Seoyeon Lee', role: '신부 · 이재현·최은주의 차녀', roleEn: 'Bride · Second Daughter of Jaehyun Lee & Eunju Choi', phone: '010-9876-5432', avatarUrl: '' },
  ],
  ...
  ] as { label: string; bankName: string; accountNumber: string; holder: string; }[],
  kakaoPayUrl: '',
  contacts: [
