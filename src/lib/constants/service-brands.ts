...
export const SERVICE_BRANDS: Record<string, ServiceBrand> = {
  ...
  gabia:                  { localPath: '/icons/gabia.svg', color: '#2B328C', darkColor: '#5A60B8', emoji: '🌐', multiColor: true },
  'hosting-kr':           { localPath: '/icons/hosting-kr.svg', color: '#0055AA', darkColor: '#4D88CC', emoji: '🖥️', multiColor: true },
  dotname:                { localPath: '/icons/dotname.svg', color: '#0066CC', darkColor: '#4D99E6', emoji: '🌐', multiColor: true },
  inames:                 { localPath: '/icons/inames.svg', color: '#003399', darkColor: '#4D77CC', emoji: '🌐', multiColor: true },
  whois:                  { localPath: '/icons/whois.svg', color: '#003E7E', darkColor: '#4D7AB3', emoji: '🌐', multiColor: true },
  ...
  criteo:                 { localPath: '/icons/criteo.svg', color: '#FE5000', darkColor: '#FF7A3D', emoji: '📊', multiColor: true },
  taboola:                { localPath: '/icons/taboola.svg', color: '#0056F0', darkColor: '#4D7FFF', emoji: '📰', multiColor: true },
  'amazon-aps':           { localPath: '/icons/amazon-aps.svg', color: '#002F36', darkColor: '#FF9900', emoji: '📢', multiColor: true },
  'google-ad-manager':    { localPath: '/icons/google-ad-manager.svg', color: '#4285F4', darkColor: '#8AB4F8', emoji: '📢', multiColor: true },

  // --- AI 서비스 Phase 5 ---
  grok:                   { localPath: '/icons/grok.svg', color: '#000000', darkColor: '#ffffff', emoji: '🤖', multiColor: true },
  ...
  'ai21-labs':            { localPath: '/icons/ai21.svg', color: '#5B2EAA', darkColor: '#8B6FDB', emoji: '🧠', multiColor: true },
  midjourney:             { localPath: '/icons/midjourney.svg', color: '#000000', darkColor: '#ffffff', emoji: '🎨' },
  'runway-ml':            { localPath: '/icons/runway.svg', color: '#0C0C0C', darkColor: '#ffffff', emoji: '🎬', multiColor: true },
  ...
  'amazon-q-developer':   { localPath: '/icons/amazon-q.svg', color: '#232F3E', darkColor: '#FF9900', emoji: '🤖', multiColor: true },
  weaviate:               { localPath: '/icons/weaviate.svg', color: '#00D1A0', darkColor: '#00D1A0', emoji: '🔷', multiColor: true },
  qdrant:                 { localPath: '/icons/qdrant.svg', color: '#DC244C', darkColor: '#E45572', emoji: '🔴', multiColor: true },
  chroma:                 { localPath: '/icons/chroma.svg', color: '#1A1A2E', darkColor: '#ffffff', emoji: '🎨', multiColor: true },
  ...
  polar:                  { localPath: '/icons/polar.svg', color: '#0062FF', darkColor: '#4D91FF', emoji: '💰', multiColor: true },
  ...
  aladin:       { localPath: '/icons/aladin.svg', emoji: '📚', color: '#2E86C1', darkColor: '#5DADE2', multiColor: true },
  'cloud-run':  { slug: 'googlecloud',  color: '#4285F4', darkColor: '#8AB4F8', emoji: '☁️' },
  readingtree:  { localPath: '/icons/readingtree.svg', emoji: '🌳', color: '#2ECC71', darkColor: '#58D68D', multiColor: true },
};
