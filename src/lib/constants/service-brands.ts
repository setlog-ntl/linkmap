...
export const SERVICE_BRANDS: Record<string, ServiceBrand> = {
  ...
  criteo:                 { slug: 'criteo',             color: '#F46F25', darkColor: '#F48C54', emoji: '📊' },
  taboola:                { slug: 'taboola',            color: '#003CFF', darkColor: '#4D6FFF', emoji: '📰' },
  ...
  'mistral-ai':           { slug: 'mistral',            color: '#000000', darkColor: '#FF7000', emoji: '🌀' },
  cohere:                 { slug: 'cohere',             color: '#39594D', darkColor: '#6BD9A4', emoji: '🧠' },
  deepseek:               { slug: 'deepseek',           color: '#4D6BFE', darkColor: '#7B93FE', emoji: '🔍' },
  perplexity:             { slug: 'perplexity',         color: '#1FB8CD', darkColor: '#1FB8CD', emoji: '🔍' },
  'ai21-labs':            { color: '#5B2EAA', darkColor: '#8B6FDB', emoji: '🧠' },
  midjourney:             { slug: 'midjourney',         color: '#000000', darkColor: '#ffffff', emoji: '🎨' },
  'runway-ml':            { slug: 'runwayml',           color: '#000000', darkColor: '#ffffff', emoji: '🎬' },
  sora:                   { slug: 'openai',             color: '#412991', darkColor: '#A78BFA', emoji: '🎬' },
  'leonardo-ai':          { color: '#A855F7', darkColor: '#C084FC', emoji: '🎨' },
  deepgram:               { slug: 'deepgram',           color: '#13EF93', darkColor: '#13EF93', emoji: '🎙️' },
  assemblyai:             { slug: 'assemblyai',         color: '#000000', darkColor: '#ffffff', emoji: '🎤' },
  playht:                 { color: '#7C3AED', darkColor: '#A78BFA', emoji: '🗣️' },
  windsurf:               { color: '#09B6A2', darkColor: '#09B6A2', emoji: '🏄' },
  tabnine:                { slug: 'tabnine',            color: '#6B57FF', darkColor: '#8B7AFF', emoji: '⌨️' },
  'amazon-q-developer':   { color: '#232F3E', darkColor: '#FF9900', emoji: '🤖' },
  weaviate:               { slug: 'weaviate',           color: '#00D1A0', darkColor: '#00D1A0', emoji: '🔷' },
  qdrant:                 { slug: 'qdrant',             color: '#DC244C', darkColor: '#E45572', emoji: '🔴' },
  chroma:                 { slug: 'chroma',             color: '#000000', darkColor: '#ffffff', emoji: '🎨' },
  crewai:                 { color: '#FF4F00', darkColor: '#FF7A3D', emoji: '👥' },
  dify:                   { slug: 'dify',               color: '#1677FF', darkColor: '#4D9AFF', emoji: '🤖' },
  'together-ai':          { color: '#0F6FFF', darkColor: '#4D96FF', emoji: '🤝' },
  'fireworks-ai':         { color: '#6B3FA0', darkColor: '#9B6FDB', emoji: '🎆' },
  modal:                  { color: '#28A745', darkColor: '#5BC479', emoji: '☁️' },
  ...
  polar:                  { slug: 'polar',              color: '#0062FF', darkColor: '#4D91FF', emoji: '💰' },

  // --- 기존 v1 서비스 누락분 ---
  auth0:                  { slug: 'auth0',              color: '#EB5424', darkColor: '#EB5424', emoji: '🔐' },
  'aws-ses':              { slug: 'amazonses',          color: '#DD344C', darkColor: '#E56478', emoji: '📨' },
  cafe24:                 { color: '#2FC98E', darkColor: '#2FC98E', emoji: '🛒' },
  ...
  imagekit:               { slug: 'imagekit',           color: '#007BFF', darkColor: '#4DA3FF', emoji: '🖼️' },
  ...
  pinecone:               { slug: 'pinecone',           color: '#000000', darkColor: '#ffffff', emoji: '🌲' },
  ...
  'stability-ai':         { slug: 'stabilityai',        color: '#000000', darkColor: '#ffffff', emoji: '🎨' },
  storybook:              { slug: 'storybook',          color: '#FF4785', darkColor: '#FF4785', emoji: '📖' },
  'toss-payments':        { slug: 'toss',              color: '#0064FF', darkColor: '#4D91FF', emoji: '💳' },
  ...
  // --- 광고/미디어 ---
  gwanggo:                { color: '#FF6B00', darkColor: '#FF8F3D', emoji: '📢' },
