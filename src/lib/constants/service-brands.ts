...
export const SERVICE_BRANDS: Record<string, ServiceBrand> = {
  ...
  cohere:                 { color: '#39594D', darkColor: '#6BD9A4', emoji: '🧠' },
  deepseek:               { color: '#4D6BFE', darkColor: '#7B93FE', emoji: '🔍' },
  perplexity:             { slug: 'perplexity',         color: '#1FB8CD', darkColor: '#1FB8CD', emoji: '🔍' },
  'ai21-labs':            { color: '#5B2EAA', darkColor: '#8B6FDB', emoji: '🧠' },
  midjourney:             { color: '#000000', darkColor: '#ffffff', emoji: '🎨' },
  ...
  assemblyai:             { color: '#000000', darkColor: '#ffffff', emoji: '🎤' },
  playht:                 { color: '#7C3AED', darkColor: '#A78BFA', emoji: '🗣️' },
  windsurf:               { color: '#09B6A2', darkColor: '#09B6A2', emoji: '🏄' },
  tabnine:                { color: '#6B57FF', darkColor: '#8B7AFF', emoji: '⌨️' },
  ...
  dify:                   { color: '#1677FF', darkColor: '#4D9AFF', emoji: '🤖' },
  ...
  imagekit:               { color: '#007BFF', darkColor: '#4DA3FF', emoji: '🖼️' },
  ...
  pinecone:               { color: '#000000', darkColor: '#ffffff', emoji: '🌲' },
  ...
  'stability-ai':         { color: '#000000', darkColor: '#ffffff', emoji: '🎨' },
  storybook:              { slug: 'storybook',          color: '#FF4785', darkColor: '#FF4785', emoji: '📖' },
  'toss-payments':        { color: '#0064FF', darkColor: '#4D91FF', emoji: '💳' },
