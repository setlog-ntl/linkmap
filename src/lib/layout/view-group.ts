...
const CATEGORY_TO_GROUP: Record<ServiceCategory, ViewGroup> = {
  ...
  ai: 'intelligence',
  storage: 'infra', monitoring: 'infra', logging: 'infra', cicd: 'infra', testing: 'infra', code_quality: 'infra', media: 'infra', queue: 'infra', feature_flags: 'infra', scheduling: 'infra', automation: 'infra', other: 'infra', domain: 'runtime',
};
