...
function FlowLayerNode({ data }: NodeProps) {
  ...
  return (
    <div
      className={`px-5 py-3.5 rounded-xl border-2 shadow-md transition-all duration-300 min-w-[140px] bg-[#111]
        ${isHighlighted ? 'border-[#2bee79] shadow-[0_0_15px_rgba(43,238,121,0.2)] scale-105' : 'border-zinc-700 hover:scale-[1.02]'}
      `}
    >
      ...
      <div className="text-center">
        ...
        <div className={`font-bold text-sm ${isHighlighted ? 'text-[#2bee79]' : 'text-white'}`}>{d.label}</div>
