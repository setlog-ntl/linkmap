...
export function SocialProofSection() {
  ...
  return (
    <section className="py-16 bg-white border-y border-[#dde0e7]" id="social-proof">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        {/* Stats */}
        <ScrollReveal>
          <p className="text-center text-sm text-[#63738a] pb-2 font-medium">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {testimonials.map((item, i) => (
            <ScrollReveal key={item.nameKey} delay={i * 0.1}>
              <div className="rounded-2xl border border-[#dde0e7] bg-[#fafbfc] p-6 h-full flex flex-col transition-all hover:shadow-md hover:-translate-y-0.5">
