...
export function AiFeaturesSection() {
  ...
  return (
    <section className="relative py-24 bg-[#0a0a0a] overflow-hidden" id="ai-features">
      {/* Green gradient glow */}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        <ScrollReveal>
          <div className="text-center mb-16">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-4 py-1.5 text-xs font-medium text-[#2bee79]">
          ...
          {features.slice(0, 3).map((feature, i) => {
            ...
            return (
              <ScrollReveal key={feature.titleKey} delay={i * 0.1}>
                <div className="group rounded-2xl border border-zinc-800 bg-zinc-900/60 backdrop-blur-sm p-6 h-full transition-all hover:border-emerald-500/30 hover:bg-zinc-900/80 hover:shadow-[0_0_20px_rgba(43,238,121,0.08)]">
