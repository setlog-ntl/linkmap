...
import { Heart, MessageSquare, Crown, Medal, Eye, Star } from 'lucide-react';
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2 shrink-0">
                <span className="flex items-center gap-1 text-xs text-muted-foreground" title="스코어">
                  <Star className="h-3.5 w-3.5 text-brand-blue" />
                  {item.score ?? 0}
                </span>
                <span className="flex items-center gap-1 text-xs text-muted-foreground" title="추천">
                  <Heart className="h-3.5 w-3.5 text-red-400" />
                  {item.like_count ?? 0}
                </span>
                <span className="flex items-center gap-1 text-xs text-muted-foreground hidden sm:flex" title="조회">
                  <Eye className="h-3.5 w-3.5" />
                  {item.view_count ?? 0}
                </span>
                <span className="flex items-center gap-1 text-xs text-muted-foreground hidden sm:flex" title="댓글">
