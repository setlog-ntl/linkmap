...
import { DomainSection } from './deploy-guide/domain-section';
import { DnsSection } from './deploy-guide/dns-section';
import { ServerHostingSection } from './deploy-guide/server-hosting-section';
import { DeployFlowSection } from './deploy-guide/deploy-flow-section';

const sections = [
  { id: 'domain', label: '도메인' },
  { id: 'dns', label: 'DNS' },
  { id: 'server-hosting', label: '서버·호스팅·CDN' },
